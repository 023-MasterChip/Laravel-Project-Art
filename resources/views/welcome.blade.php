...
<body>
    <div class="fixed">
        ...
        <div class="w-full h-screen bg-gradient-to-r from-green-500 to-green-200 mb-2 lg:flex lg:flex-shrink-0">
                ...
                <div class="flex-1 flex flex-col w-64 max-h-screen border-r border-gray-400 bg-gray-200">
                    ...
                    <a href="{{ url('/profile') }}" class="flex-shrink-0 w-full group block">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-green-700 group-hover:text-gray-900">
                                        {{ Auth::user()->name }}</p>
                            ...
                            <li
                                ...
                                <div class="flex-1 flex flex-col p-8">
                                    ...
                                    <dl class="mt-1 flex-grow flex flex-col justify-between">
                                        ...
                                        <dd class="mt-3">
                                            <span
                                                class="px-2 py-1 text-green-800 text-xs font-medium bg-green-100 rounded-full">Artist</span>
                                        </dd>
                                    </dl>
                                </div>
                                <div>
                                    <div class="-mt-px flex divide-x divide-gray-200">
                                        <div class="w-0 flex-1 flex">
                                            <a href="{{ url('/artist', $user->id) }}"
                                                class="relative -mr-px w-0 flex-1 inline-flex items-center justify-center py-4 text-sm text-green-700 font-medium border border-transparent rounded-bl-lg hover:text-gray-500">
