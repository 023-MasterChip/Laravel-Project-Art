  ...
  <div class="hidden w-28 overflow-y-auto bg-gray-400 md:block">
    ...
    <div class="flex items-center flex-shrink-0 px-4">
      ...
      <div class="mt-6 w-full flex-1 space-y-1 px-2">
        ...
        <a href="{{ url('/profile') }}" class="text-green-100 hover:bg-green-800 hover:text-white group w-full p-3 rounded-md flex flex-col items-center text-xs font-medium" aria-current="page">
          <!-- Heroicon name: outline/photo -->
          <svg class="text-green-300 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
          </svg>
          <span class="mt-2">My Artworks</span>
        </a>

        <a href="#" class="uploadArt text-green-100 hover:bg-green-800 hover:text-white group w-full p-3 rounded-md flex flex-col items-center text-xs font-medium">
          <!-- Heroicon name: outline/user-group -->
          <svg class="text-green-300 group-hover:text-white h-6 w-6 mb-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 8.25H7.5a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H15m0-3l-3-3m0 0l-3 3m3-3V15" /></svg>
        ...
        <a href="/settings" class="bg-green-800 text-white group w-full p-3 rounded-md flex flex-col items-center text-xs font-medium">
          <!-- Heroicon name: outline/user-group -->
        ...
        <a href="/login" class="text-green-100 hover:bg-green-800 hover:text-white group w-full p-3 rounded-md flex flex-col items-center text-xs font-medium">
          <!-- Heroicon name: outline/user-group -->
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor"
                                        class="text-green-300 group-hover:text-white h-6 w-6">
   ...
   <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
     ...
     <div>
       ...
       <div>
           ...
           <div class="mt-1">
             <input type="text" name="name" id="name" class="block w-80 h-10 rounded-md border border-gray-400 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm" placeholder="">
           </div>
         </div>
       </div>
       <div class="mt-5 sm:mt-6">
         <button type="submit" name="submit" class="inline-flex w-full justify-center rounded-md border border-transparent bg-green-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 sm:text-sm">Update</button>
       </div>
     </form>
     </div>
   </div>
    ...
    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
      ...
      <div>
        ...
        <div>
            ...
            <div class="mt-1">
              <input type="text" name="email" id="email" class="block w-80 h-10 rounded-md border border-gray-400 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm" placeholder="">
            </div>
          </div>
        </div>
        <div class="mt-5 sm:mt-6">
                      ...
                      <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                        ...
                        <dd class="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                          ...
                          <span class="ml-4 flex-shrink-0">
                            <button type="button" class="updateName rounded-md bg-white font-medium text-green-600 hover:text-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Update</button>
                          </span>
                        </dd>
                      </div>
                      <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:pt-5">
                        ...
                        <dd class="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                          ...
                          <span class="ml-4 flex flex-shrink-0 items-start space-x-4">
                            <button type="button" class="updateImg rounded-md bg-white font-medium text-green-600 hover:text-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Update</button>
                            <span class="text-gray-300" aria-hidden="true">|</span>
                            <a href="{{ url('deleteImg') }}"><button type="button" class="rounded-md bg-white font-medium text-green-600 hover:text-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Remove</button></a>
                          </span>
                        </dd>
                      </div>
                      <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:pt-5">
                        ...
                        <dd class="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                          ...
                          <span class="ml-4 flex-shrink-0">
                            <button type="button" class="updateEmail rounded-md bg-white font-medium text-green-600 hover:text-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Update</button>
                          </span>
                        </dd>
                      </div>
                    </dl>
                    ...
                    <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                      <div>
                        ...
                        <div class="mt-1 sm:col-span-2 sm:mt-0">
                                <div class="flex max-w-lg justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
                                  <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                      <label for="fileupload" class="relative cursor-pointer rounded-md bg-white font-medium text-green-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-green-500 focus-within:ring-offset-2 hover:text-green-500">
                                        Choose file
                                      </label>
                                ...
                                <div class="mt-2 ml-1 grid grid-cols-2 gap-4">
                                 <div class="col-span-1 relative flex items-start">
                                    <div class="flex h-5 items-center">
                                      <input id="fantasy" name="fantasy" type="checkbox" value="fantasy" class="h-4 w-4 rounded border-gray-300 text-green-600 focus:ring-green-500">
                                    </div>
                                  ...
                                  <div class="col-span-1 relative flex items-start">
                                    <div class="flex h-5 items-center">
                                      <input id="comic" name="comic" type="checkbox" value="comic" class="h-4 w-4 rounded border-gray-300 text-green-600 focus:ring-green-500">
                                    </div>
                                    <div class="ml-3 text-sm">
                                  ...
                                  <div class="col-span-1 relative flex items-start">
                                    <div class="flex h-5 items-center">
                                      <input id="concept" name="concept" type="checkbox" value="concept" class="h-4 w-4 rounded border-gray-300 text-green-600 focus:ring-green-500">
                                    </div>
                                    <div class="ml-3 text-sm">
                                  ...
                                  <div class="col-span-1 relative flex items-start">
                                    <div class="flex h-5 items-center">
                                      <input id="abstract" name="abstract" type="checkbox" value="abstract" class="h-4 w-4 rounded border-gray-300 text-green-600 focus:ring-green-500">
                                    </div>
                                    <div class="ml-3 text-sm">
                                  ...
                                  <div class="col-span-1 relative flex items-start">
                                    <div class="flex h-5 items-center">
                                      <input id="illustration" name="illustration" type="checkbox" value="illustration" class="h-4 w-4 rounded border-gray-300 text-green-600 focus:ring-green-500">
                                    </div>
                                    <div class="ml-3 text-sm">
                                ...
                                <div class="mt-5 sm:mt-6">
                                  <button type="submit" class="inline-flex w-full justify-center rounded-md border border-transparent bg-green-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 sm:text-sm">Upload Art</button>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="mt-1 sm:col-span-2 sm:mt-0">
                                <div class="flex max-w-lg justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
                                  <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                      <label for="upload" class="relative cursor-pointer rounded-md bg-white font-medium text-green-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-green-500 focus-within:ring-offset-2 hover:text-green-500">
                                        Choose file
                                      </label>
                                ...
                                <div class="mt-5 sm:mt-6">
                                  <button type="submit" class="inline-flex w-full justify-center rounded-md border border-transparent bg-green-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 sm:text-sm">Update Profile Picture</button>
                                </div>
                              </div>
                            </div>
                          </div>
